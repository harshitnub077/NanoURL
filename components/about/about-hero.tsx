  ...
  return (
    <section className="container py-16 md:py-24">
      ...
      >
        ...
        >
          About <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-green-600">NanoURL</span>
        </motion.h1>
        ...
        >
          <div className="bg-card p-8 rounded-xl shadow-sm border">
            ...
            <p className="text-muted-foreground">
              NanoURL was created with a simple mission: to make sharing links easier and more efficient.
