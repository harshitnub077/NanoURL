...
export function Faq() {
  ...
  const faqs = [
    {
      question: "What is NanoURL?",
      answer: "NanoURL is a link shortening service that allows you to create short, memorable links from long URLs. It also provides analytics and QR code generation features."
    },
    {
      question: "Is NanoURL free to use?",
      answer: "Yes, NanoURL offers a free tier that includes basic link shortening features. We also offer premium plans with advanced analytics and custom branding options."
    },
    {
    ...
    },
    {
      ...
      answer: "Absolutely! NanoURL provides analytics for all shortened links, allowing you to track clicks, geographic data, and referral sources."
    },
    {
